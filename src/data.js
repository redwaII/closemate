...
const EVALUATION_RULES = [
  {
    id: "empathy",
    title: "Эмпатия",
    description: "Есть уважительный тон и признание позиции клиента.",
  },
  {
    id: "clarity",
    title: "Конкретика",
    description: "Есть понятный следующий шаг или вопрос.",
  },
  {
    id: "value",
    title: "Ценность",
    description: "Объяснена польза, а не только цена/скидка.",
  },
];
